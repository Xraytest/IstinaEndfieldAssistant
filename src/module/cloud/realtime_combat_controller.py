"""
Realtime Combat Controller
Large VLM judges combat state, delegates to small VLM for real-time control
TPS monitoring, 3C actions: movement, skill, jump, dodge
"""
import os
import sys
import time
...
try:
    from module.logger import get_logger, LogCategory
    logger = get_logger()
except ImportError:
    import logging
    logger = logging.getLogger("RealtimeCombatController")
    class LogCategory:
        MAIN = "main"
        INFERENCE = "inference"
