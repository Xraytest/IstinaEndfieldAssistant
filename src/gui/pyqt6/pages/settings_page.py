...
try:
    ...
    from gui.pyqt6.widgets.base_widgets import ElevatedCardWidget
    from gui.pyqt6.pages.settings.workers import GPUCheckWorker, ModelDownloadWorker
    from gui.pyqt6.pages.settings.settings_cards import (
        LocalInferenceSettingsCard,
        HardwareSettingsCard,
        CacheSettingsCard,
        TouchSettingsCard,
...
class SettingsPage(QWidget):
    ...
    def __init__(
        ...
        self._dev_card: Optional[DevSettingsCard] = None
    ...
    def _setup_ui(self) -> None:
        ...
        # === 开发选项设置卡片 ===
        self._dev_card = DevSettingsCard(self._config, self)
        self._dev_card.settings_changed.connect(self._on_dev_settings_changed)
        main_layout.addWidget(self._dev_card)
    ...
    def _on_dev_settings_changed(self, settings: Dict[str, Any]) -> None:
        """开发选项设置变更"""
        self._config.update(settings)
        self.settings_changed.emit(settings)
