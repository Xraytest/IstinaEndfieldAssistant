...
try:
    ...
    from gui.pyqt6.widgets.task_list import TaskListItem, DragDropTaskList
    from gui.pyqt6.widgets.device_preview import DevicePreviewWidget
    from gui.pyqt6.widgets.status_indicator import ConnectionStatusIndicator, StatusIndicatorWidget
...
class IEAPage(QWidget):
    ...
    def append_log(self, message: str, level: str = "INFO") -> None:
        ...
        colors = {"INFO": "#a0a0b8", "SUCCESS": "#4a9a6a", "WARNING": "#c8a84e", "ERROR": "#c85a4a"}
        color = colors.get(level, "#a0a0b8")
        self._log_text.append(
            f'<span style="color: #585878;">[{timestamp}]</span> '
