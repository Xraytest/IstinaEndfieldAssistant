...
try:
    ...
    from gui.pyqt6.widgets.base_widgets import PrimaryButton, SecondaryButton, CardWidget
    from gui.pyqt6.widgets.status_indicator import ConnectionStatusIndicator, DualStatusIndicator
