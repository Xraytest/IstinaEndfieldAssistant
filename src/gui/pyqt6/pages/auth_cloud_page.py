...
try:
    ...
    from gui.pyqt6.widgets.base_widgets import PrimaryButton, SecondaryButton, CardWidget, DangerButton
...
class AuthCloudPage(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._tab_widget.addTab(self._cloud_tab, "云服务")
    ...
    def _setup_style(self) -> None:
        ...
        tab_style = f"""
            ...
            QTabBar::tab:hover:!selected {{
                background-color: rgba(60, 60, 100, 0.15);
            }}
        """
    ...
    def _update_auth_tab_user_info(self, user_info: Optional[Dict[str, Any]]) -> None:
        ...
        if user_info:
            ...
            tier_colors = {
                ...
                'plus': self._theme.get_color('accent_gold'),
                'pro': self._theme.get_color('danger'),
            }
