...
try:
    ...
    from gui.pyqt6.widgets.log_display import LogDisplayWidget
    from gui.pyqt6.pages import AuthPage, SettingsPage, CloudPage, AuthCloudPage, IEAPage, ModelManagerPage
