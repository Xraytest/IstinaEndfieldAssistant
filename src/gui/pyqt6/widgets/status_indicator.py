...
class StatusIndicatorWidget(QWidget):
    ...
    def _get_status_color(self) -> str:
        """获取当前状态对应的颜色 - Arknights 风格"""
        colors = {
            self.STATUS_CONNECTED: '#4a9a6a',      # 青绿
            self.STATUS_CONNECTING: '#c8a84e',     # 琥珀金
            self.STATUS_DISCONNECTED: '#c85a4a',   # 赤红
            self.STATUS_ERROR: '#e07a6a',          # 浅赤
        }
        return colors.get(self._current_status, '#585878')
