...
try:
    ...
    from gui.pyqt6.theme.animation_manager import AnimationManager
...
class NavigationButton(BaseButton):
    ...
    def __init__(
        ...
        self._hover_bg_color = "rgba(74, 111, 165, 0.15)"
        self._pressed_bg_color = "rgba(74, 111, 165, 0.3)"
        self._selected_bg_color = "rgba(74, 111, 165, 0.2)"
    ...
    def _update_style_with_bg(self, bg_color: str) -> None:
        ...
        """
        # 构建样式表
        selected_border = "3px solid #4a6fa5" if self._selected else "none"
        text_color = "#ececf0" if self._selected else "#a0a0b8"
